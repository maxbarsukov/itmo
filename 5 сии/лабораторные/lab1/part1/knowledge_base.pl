...
has_access_to_sea(savoy, mediterranean).
has_access_to_sea(other_france, mediterranean).
...
has_access_to_sea(other_italy, mediterranean).
...
has_access_to_sea(whole_spain, mediterranean).
...
has_access_to_sea(whole_turkey, mediterranean).
has_access_to_sea(istanbul, black_sea).
has_access_to_sea(istanbul, mediterranean).
