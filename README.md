...
Я буду рад увидеть ваши идеи, предложения и любые материалы, которые вы хотели бы добавить в репозиторий. \
Не стесняйтесь отправлять **Pull request** :mailbox_with_mail:, чтобы я добавил вашу информацию!
...
| [Компьютерные сети](./6%20компьютерные%20сети) | | | | | | :construction: | | |
| Обработка сигналов | | | | | | :construction: | | |
| Основы сетевых технологий | | | | | | :construction: | | |
| [Разработка мобильных приложений](./6%20рмп) | | | | | | :construction: | | |
| [Распределенные системы хранения данных](./6%20рсхд) | | | | | | :construction: | | |
| Системы ввода-вывода | | | | | | :construction: | | |
...
| [Vsev0l0d](https://github.com/Vsev0l0d?tab=repositories), [RomanVassilchenko/ITMOProjects](https://github.com/RomanVassilchenko/ITMOProjects), [testpassword](https://github.com/testpassword?tab=repositories) | Репозитории студентов (поступили до 2022) |
