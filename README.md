...
В каждой папке (формата `<семестр> <аббревиатура предмета>`) содержится описание предмета (разъяснения по непонятным моментам, решения проблем, которые могут возникнуть в ходе обучения, и др.), а также любые другие материалы по профильным (и не только) предметам по **направлению СППО** и **кафедре ВТ**:
...
> [!TIP]
> Чтобы скачать какую-то папку, не обязательно клонировать репозиторий целиком (он довольно тяжелый). \
> Вы можете скачать любой каталог как `.zip`-архив в [itmo.maxbarsukov.ru/repo/](https://itmo.maxbarsukov.ru/repo/).
...
| [Операционные системы](./5%20оси) | | | | | :construction: | | | |
...
| Бизнес-логика программных систем | | | | | | :construction: | | |
| Компьютерные сети | | | | | | :construction: | | |
| Обработка сигналов | | | | | | :construction: | | |
| Основы сетевых технологий | | | | | | :construction: | | |
| Разработка мобильных приложений | | | | | | :construction: | | |
| Распределенные системы хранения данных | | | | | | :construction: | | |
| Системы ввода-вывода | | | | | | :construction: | | |
| Тестирование программного обеспечения | | | | | | :construction: | | |
| Философия | | | | | | :construction: | | |
