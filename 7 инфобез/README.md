...
- 7 семестр: **зачёт** (101/100 баллов).
...
- [Рубежная работа №2 (15/15)](./рубежки/2/).

## Лекции

На лекциях проходят [практикумы](./практика/), за участие в которых можно получить дополнительные баллы.
...
7. [Искусственный интеллект и информационная безопасность](./лекции/Лекция%207.pptx) (`15.10`);
...
11. [Анализ архитектуры с точки зрения ИБ](./лекции/Лекция%2010.pptx) (`12.11`) + [доклад](./лекции/доклады/Доклад%20XSS.pdf) + [практикум](./практика/5.%20лекция%2012.11.2025/);
12. [Практики анализа безопасности кода](./лекции/Лекция%2011.pptx) (`19.11`);
13. [Личная цифровая безопасность](./лекции/Лекция%2012.pptx) (`26.11`);
14. [Инциденты ИБ в реальном мире](./лекции/Лекция%2013.pdf) (`03.12`);
