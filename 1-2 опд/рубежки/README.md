...
| Ссылка                                                                                      | Описание                      |
| ------------------------------------------------------------------------------------------- | ----------------------------- |
| [Гайд по 3-ей рубежке](https://github.com/sergeypugin/ITMO/tree/main/1-2_OPD/sem2/rubezh_3) | Новый 3-й рубеж по ОПД (2026) |
| [4.md](./4.md)                                                                              | Новый 4-й рубеж по ОПД (2026) |
